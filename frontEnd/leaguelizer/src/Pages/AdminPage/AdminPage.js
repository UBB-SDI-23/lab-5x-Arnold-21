...
export default function AdminPage(){
    ...
    var getUrlForStadiums = useCallback(() => {
        return "https://SArnold-sdi-22-23.mooo.com/api/stadiums/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])

    var getUrlForClubs = useCallback(() => {
        return "https://SArnold-sdi-22-23.mooo.com/api/clubs/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])
    
    var getUrlForCompetitions = useCallback(() => {
        return "https://SArnold-sdi-22-23.mooo.com/api/competitions/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])

    var getUrlForMatches = useCallback(() => {
        return "https://SArnold-sdi-22-23.mooo.com/api/matches/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])
    ...
    useEffect(() => {
        if (stadiumListVisible){
            ...
            setDeleteMatchList([]);
            fetch("https://SArnold-sdi-22-23.mooo.com/api/stadiums/?pageNumber=" + String(paginationValue))
        ...
        if (clubListVisible){
            ...
            setDeleteCompetitionList([]);
            setDeleteMatchList([]);
            fetch("https://SArnold-sdi-22-23.mooo.com/api/clubs/?pageNumber=" + String(paginationValue))
                .then(number => number.json())
                .then(number => setPageMax(number["pageNumber"]));
        }
        if (competitionListVisible){
            ...
            setDeleteStadiumList([]);
            setDeleteMatchList([]);
            fetch("https://SArnold-sdi-22-23.mooo.com/api/competitions/?pageNumber=" + String(paginationValue))
                .then(number => number.json())
                .then(number => setPageMax(number["pageNumber"]));
        }
        if (matchListVisible){
            ...
            setDeleteCompetitionList([]);
            setDeleteStadiumList([]);
            fetch("https://SArnold-sdi-22-23.mooo.com/api/matches/?pageNumber=" + String(paginationValue))
                .then(number => number.json())
                .then(number => setPageMax(number["pageNumber"]));
        }
    ...
    const stadiumDeleteButtonHandler = () => {
        ...
        const URL = "https://SArnold-sdi-22-23.mooo.com/api/admin/stadiums/";
    ...
    const clubDeleteButtonHandler = () => {
        ...
        const URL = "https://SArnold-sdi-22-23.mooo.com/api/admin/clubs/";
        fetch(URL, requestOptions)
            .then(() => {refreshPages();});
    }
    ...
    const competitionDeleteButtonHandler = () => {
        ...
        const URL = "https://SArnold-sdi-22-23.mooo.com/api/admin/competitions/";
        fetch(URL, requestOptions)
            .then(() => {refreshPages();});
    }
    ...
    const matchDeleteButtonHandler = () => {
        ...
        const URL = "https://SArnold-sdi-22-23.mooo.com/api/admin/matches/";
        fetch(URL, requestOptions)
            .then(() => {refreshPages();});
    }
